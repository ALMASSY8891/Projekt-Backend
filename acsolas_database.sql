...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Jan 22. 17:15
...
--
-- Tábla szerkezet ehhez a táblához `depot`
--
...
--
-- AUTO_INCREMENT a táblához `depot`
--
ALTER TABLE `depot`
...
--
-- Megkötések a táblához `depot`
--
ALTER TABLE `depot`
  ADD CONSTRAINT `depot_ibfk_1` FOREIGN KEY (`Product Code`) REFERENCES `product` (`Product_Code`);
